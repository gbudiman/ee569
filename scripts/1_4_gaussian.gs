...
set title "Matched Histogram 2"
plot "images/P2/Student_2_matched_hist_gray_pdf.txt" smooth freq with boxes lt rgb "#101010" axes x1y1, "images/P2/Student_2_matched_hist_gray_cdf.txt" with line axes x1y2